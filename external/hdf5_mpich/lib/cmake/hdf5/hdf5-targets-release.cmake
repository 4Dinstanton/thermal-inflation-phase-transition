...
set_target_properties(hdf5-shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhdf5.320.2.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libhdf5.320.dylib"
  )

list(APPEND _cmake_import_check_targets hdf5-shared )
list(APPEND _cmake_import_check_files_for_hdf5-shared "${_IMPORT_PREFIX}/lib/libhdf5.320.2.0.dylib" )
...
set_target_properties(hdf5_tools-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhdf5_tools.320.0.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libhdf5_tools.320.dylib"
  )

list(APPEND _cmake_import_check_targets hdf5_tools-shared )
list(APPEND _cmake_import_check_files_for_hdf5_tools-shared "${_IMPORT_PREFIX}/lib/libhdf5_tools.320.0.3.dylib" )
...
set_target_properties(hdf5_hl-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhdf5_hl.320.0.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libhdf5_hl.320.dylib"
  )

list(APPEND _cmake_import_check_targets hdf5_hl-shared )
list(APPEND _cmake_import_check_files_for_hdf5_hl-shared "${_IMPORT_PREFIX}/lib/libhdf5_hl.320.0.3.dylib" )
